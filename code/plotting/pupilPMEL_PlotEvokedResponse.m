function [ ] = pupilPMEL_PlotEvokedResponse( plotHandle, timebase, meanResponse, errorResponse, varargin)
...
xlabel(plotHandle,p.Results.xUnits); ylabel(plotHandle,'% pupil change');
